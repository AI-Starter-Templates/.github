...
A running log of substantial changes to the docs, the templates, and the supporting tooling. For per-commit detail, see the git history of each [sibling repo](https://github.com/AI-Starter-Templates). For the latest released images, see the [Image updates runbook](/runbooks/image-updates/).
...
- **Agent docs as an index.** `AGENTS.md` now acts as a navigation table over `docs/agents/`; the docs site mirrors the same shape.
...
- Star the [AI-Starter-Templates](https://github.com/AI-Starter-Templates) GitHub org to surface releases in your feed.
