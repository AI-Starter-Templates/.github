...
1. **Enable Workers Paid.**
   Cloudflare dashboard → Workers & Pages → Plans → upgrade to Workers Paid ($5/mo). Email Service is bundled into this plan; there's no separate billing line.
