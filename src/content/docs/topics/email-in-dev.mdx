...
Iterate on verify-email, password-reset, welcome, and notification flows without bouncing every change through Cloudflare Email Service, Resend, or SendGrid. BoringStack ships a one-flag opt-in for [Mailpit](https://mailpit.axllent.org/), a local SMTP catcher with a web UI.
