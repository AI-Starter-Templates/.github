...
Test verify-email, password-reset, welcome, and notification flows locally without sending through Cloudflare Email Service, Resend, or SendGrid. BoringStack includes [Mailpit](https://mailpit.axllent.org/), a local SMTP catcher with a web UI, available via a one-flag opt-in.
