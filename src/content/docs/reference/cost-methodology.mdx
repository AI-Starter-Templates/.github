...
The [cost calculator](/architecture/why-boringstack/#cost-calc-title) on the Why BoringStack page compares three solution categories at four usage stages. This page shows the math.

Prices reflect public list rate cards as of **2026-05**. They round generously — the goal is to put cost categories on the same scale, not to predict your bill to the cent.
...
**What's not included.** Auth-as-a-service, email, error tracking, background-job platforms — each priced separately if you adopt them.
