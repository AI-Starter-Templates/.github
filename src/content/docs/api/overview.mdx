...
The architecture is held in place by [15 custom ESLint plugins](/architecture/lint-as-contract/). Agents skip `AGENTS.md`; lint still enforces the rules. `bun run validate` is the merge gate.
