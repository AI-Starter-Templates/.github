...
>
  Authentication is shaped around one browser contract: HttpOnly cookies,
  server-side OAuth, verify-before-account signup, and DB-backed refresh
  sessions that can be rotated or revoked without exposing tokens to the UI.
</PageIntro>
