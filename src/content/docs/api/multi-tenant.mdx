          ...
          children: [
            {
              ...
              children: [
                { name: "app.account_invitations", detail: "hashed one-time invite tokens" },
                { name: "app.account_feature_overrides", detail: "manual feature gates" },
                { name: "billing.account_plans", detail: "Stripe-backed plan state" },
                { name: "app.widgets", detail: "sample @account-scoped table pattern" },
              ],
            },
          ],
        },
